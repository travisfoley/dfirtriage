...
PARSER.add_argument('-elp', '--evtlogparse', action='store_true',
                    ...
                    "[APP] 1022, 1033    [SEC] 1102, 4624, 4625, 4634,"
...
def mem_scrape():
    ...
    load_driver = mem_dir + "winpmem_3.1.rc10.exe -L"
    mem_acq_get = mem_dir + "winpmem_3.1.rc10.exe --volume_format raw -o memdump.raw"
    unload_driver = mem_dir + "winpmem_3.1.rc10.exe -U"
    # loading winpmem driver
    subprocess.call(load_driver, stderr=NOERROR)
    # executing winpmem
    subprocess.call(mem_acq_get, stderr=NOERROR)
    # unloading winpmem driver
    subprocess.call(unload_driver, stderr=NOERROR)
...
def banner():
    ...
    print(r"#  |   \| |_ |_ _| _ \  |_   _|((_|_|(_)_ (()(_|_))   #")
    print(r"#  | |) | __| | ||   /    | | | '_| / _` / _` |/ -_)  #")
    print(r"#  |___/|_|  |___|_|_\    |_| |_| |_\__,_\__, |\___|  #")
    print(r"#                                        |___/        #")
